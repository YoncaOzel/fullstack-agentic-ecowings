    ...
    public static class ServiceRegistration
    {
        public static void AddPersistenceInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseNpgsql( // UseNpgsql kullanıyoruz
            ...
            services.AddTransient<IAirportRepositoryAsync, AirportRepositoryAsync>();
            services.AddTransient<IAccountService, AccountService>();
            services.AddTransient<ITokenService, TokenService>(); // Burayı da ekledim: Login için şart!
            services.AddTransient<IUserIdentityService, UserIdentityService>();
            services.AddHttpClient<IFlightSearchService, DuffelFlightService>(); // <-- BUNU EKLEYİN
            services.Configure<DuffelSettings>(configuration.GetSection("DuffelSettings"));
            services.AddHttpClient<IEcoAgentService, GroqEcoAgentService>()
